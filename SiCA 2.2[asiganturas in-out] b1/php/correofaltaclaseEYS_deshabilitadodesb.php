<?php		
	...
	*/
	...
	if (  $hora == 7 || $hora==8 || $hora==9  || $hora==10 || $hora==11 || $hora==12 || $hora==13 || $hora==14 || $hora==15 || $hora==16 || $hora==17 || $hora==18 ){	
		...
		// FALTA: consultar la tabla horariscrn_hrs

		// ==================================================================
		//							Caso para 2 hrs
		// ==================================================================
		// #a obtener faltas EYS y add a lstFaltasEYS
		$queryFEYS = "CALL get_faltas_clases_hora_eys('$hora:00:00','02:00:00')";

		if ($resultFEYS = mysqli_query($con, $queryFEYS) ) {

			
		}

		$query = "CALL get_faltas_clases_hora('$hora:12:00')";
		//echo $query;
