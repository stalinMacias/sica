<?php
	...
	if (isset($_POST["opcion"]) && isset($_POST["correo"]) && isset($_POST["nombre"]) && isset($_POST["tipousuarios"]) ){
		$opcion = $_POST["opcion"];
		$correo = $_POST["correo"];
		$nombre = $_POST["nombre"];
		$typousuario = $_POST["tipousuarios"]
		...
		if (filter_var($correo, FILTER_VALIDATE_EMAIL)){
			...
			switch ($opcion) {
				...
				case "fuera_tolerancia":
					...
					break;
				//tolerancias del horario 20 minutos
			...
			$mensaje = " <div align='justified'>".$mensaje."<p align='justify' style='color:grey;'>Este es un correo autom&aacute;tico generado por el Sistema de Control de Asistencia (SICA) del Centro Universitario de los Valles de la Universidad de Guadalajara. No es necesario que responda a este correo.</p><p>Sistema de Control de Asistencia, CUSUR.</p></div>";	//  Favor de atender esta notificaci&oacute;n conforme se indica. se elimino por instrucciones de Marco Tulio
