...
public class AsignaturaEYSController implements Initializable {
    ...
    @FXML protected TableColumn <AsistenciaClase, String> entColDia;
    @FXML protected TableColumn <AsistenciaClase, String> salColDia;
    @FXML protected TableColumn <AsistenciaClase, String> regEntColDia;
    @FXML protected TableColumn <AsistenciaClase, String> regSalColDia;
    ...
    private void inicializarVistaTablas() {
        ...
        // -- agregados para EYS --
        entColDia.setCellValueFactory(new PropertyValueFactory<>("entrada"));
        regEntColDia.setCellValueFactory(new PropertyValueFactory<>("regentrada"));
        salColDia.setCellValueFactory(new PropertyValueFactory<>("salida"));
        regSalColDia.setCellValueFactory(new PropertyValueFactory<>("regsalida"));
